...
class Metaclass_StartMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.StartMission')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _start_mission
...
class StartMission(metaclass=Metaclass_StartMission):
    from custom_interfaces.srv._start_mission import StartMission_Request as Request
    from custom_interfaces.srv._start_mission import StartMission_Response as Response
